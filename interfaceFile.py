...
##def device_to_pc_COM(com_port):
##
##    global dataFromArduino
##    com_port = 'com'+com_port
##    dataFromArduino = serial.Serial(com_port,9600)
##    print('reached inside the device tp pc')
##    
...
def get_Attendance_Record_File_From_Serial(msg,com_port):

    com_port = 'com'+com_port
    dataFromArduino = serial.Serial(com_port,9600)
    print('reached inside the get attendance from serial')
...
def parseList():
    ...
    with open ( 'list.csv','r') as file:
        ...
        print(buff)
        file.close()
    print('top of the attendanceRedord')
